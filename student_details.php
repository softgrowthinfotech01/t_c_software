                    ...
                    <form>
                      <div class="row mb-2">
                        <div class="col-md-6 ">
                          ...
                          <div class="form-group">
                            <label for="birthVillage">Place of Birth (Village)</label>
                            <input
                            type="text"
                            class="form-control"
                            id="birthVillage"
                            placeholder="Enter Place Of Birth (Village)"
                            />
                          </div>
                        </div>
                         ...
                         <div class="col-md-6 ">
                          <div class="form-group">
                            <label for="birthTaluka">Place of Birth (Taluka)</label>
                            <input
                            type="text"
                            class="form-control"
                            id="birthTaluka"
                            placeholder="Enter Place of Birth (Taluka)"
                            />
                          </div>

                          <div class="form-group">
                             <label for="birthDistrict">Place of Birth (District)</label>
                             <input
                              type="text"
                              class="form-control"
                              id="birthDistrict"
                              placeholder="Enter Place of Birth (District)"
                              />
                           </div>

                           <div class="form-group">
                             <label for="birthstate">Place of Birth (State)</label>
                             <input
                              type="text"
                              class="form-control"
                              id="birthstate"
                          ...
                          <div class="form-group">
                             <label for="birthCountry">Place of Birth (Country)</label>
                             <input
                              type="text"
                              class="form-control"
                              id="birthCountry"
...
<!-- 
                      <div class="mb-4 ms-3">
                          ...
                          <fieldset class="border rounded p-3">
                            <legend class=" px-2 fw-normal "style="font-size: 1rem;">Educational Documents</legend>
                              <div class="row g-3">
                                 <div class="col-md-6">
                                 ...
                                 <fieldset class="border rounded p-3 mt-4">
                                   <legend class=" px-2 fw-normal" style="font-size: 1rem;">Other Documents</legend>
                                      <div class="row g-3">
                                       ...
                                       <div class="col-md-6">
                                        <div class="form-check d-flex align-items-center gap-2">
                                            ...
                                            <label 
                                              for="non-cre"
                                              class="mb-0"
                                             >NON-CRIMINAL CERTIFICATE</label>
                                            <input
                                             type="file"
                                             class="form-control form-control-sm w-auto"
                                             id="non-cre"
                           ...
                           <div class="col-md-4">
                             <div class="form-group">
                               ...
                               <select
                                 ...
                                 id="fees"
                                >
                                 <option>1<sup>st</sup> Installment</option>
                                 <option>2<sup>nd</sup> Installment</option>
                        ...
                        <div class="row">
                         <div class="col-md-6">
                          ...
                          <div class="row">
                           ...
                           <div class="col-md-6">
                             <div class="form-group">
                                <label for="remark">CHAIRMAN REMARK</label>
                                <textarea
                                class="form-control"
                                id="remark"
                                name="remark"
